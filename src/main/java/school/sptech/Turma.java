...
public class Turma {
    ...
    public void transferir(Turma destino, Integer qtdATransferir){
        if( destino != null && qtdATransferir != null && qtdATransferir > 0 && destino.ativa && qtdATransferir <= qtdAluno && ativa){
            qtdAluno -= qtdATransferir;
            destino.matricular(qtdATransferir);
        }
    }
